...
class Surcharge extends AbstractTotal
{
    ...
    public function collect(
        ...
        // (the pre-ABN-379 2dp truncation, or the interim 4dp) loses
        ...
        // boundary. See ABN-379 for the original 2dp→4dp diagnosis;
    ...
    public function fetch(Quote $quote, Total $total): array
    {
        ...
        $title = $this->checkoutSession->getTwoSurchargeDescription() ?: 'Zakelijk op Rekening';
